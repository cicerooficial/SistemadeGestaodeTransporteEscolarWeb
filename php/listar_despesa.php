...
<table cellspacing="0" cellpadding="0" border="0" class="display" id="listausers">
			<thead>
				<tr>
					<th>Id</th><th>Tipo</th><th>Data</th><th>Valor</th><th>Ações</th>
...
while ($dados = $query->fetch_array())
	...
	// mostra na tela os resultados da busca
		...
		echo '<td align="center"> ' . utf8_encode($dados['id_despesa']) . '<br /></td>';
		
		echo '<td align="center"> ' . utf8_encode($dados['nome_despesa']) . '<br /></td>';
...
$data = implode("-", array_reverse(explode("-",$data)));
		...
		echo '<td align="center">
					<a href="cadastrar_despesa.php" title="Novo cadastro"><img src="../img/add.png" alt="Novo cadastro" /></a>
					<a href="alterar_despesa.php?id_despesa='. ($dados['id_despesa']).'" title="Editar"><img src="../img/edit.png" alt="Editar" /></a>
					</tr></td>';
