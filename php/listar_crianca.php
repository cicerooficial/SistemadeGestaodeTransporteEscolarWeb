...
<table cellspacing="0" cellpadding="0" border="0" class="display" id="listausers">
			<thead>
				<tr>
					<th>ID</th><th>Nome/Apelido</th><th>Dt_Nasc/Idade</th><th>Escola/Horario</th><th>Status</th><th>Tel</th><th>Ações</th>
...
on(crianca.cpf_resp = responsavel.cpf_resp)";
...
$data = implode("-", array_reverse(explode("-",$data)));
	...
	$idade = floor((((($hoje - $nascimento) / 60) / 60) / 24) / 365.25);
		...
		echo '<td align="center">
					<a href="alterar_crianca.php?id_crianca='.($dados['id_crianca']).'" title="Editar"><img src="../img/edit.png" alt="Editar" /></a></td>';
