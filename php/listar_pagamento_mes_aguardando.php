...
<div id=content>
	   ...
	   <form class="userform" name="formulario1" method="post" action="../Relatorio/relatorio_mes_aguardando.php">
	   <fieldset id="">
		   <legend> Relatorio Mensal </legend>
				<ul>	
        	
			</br>
						
			<li><label for="mes"> Escolha o Mês:</label>
				<input name="mes" type="number" id="mes" size="20" maxlength="100"  />
			</li></br>
			<li><label for="ano"> Escolha o Ano:</label>
  ...
  <ul>
    <li class="center"><input name="cadastrar" type="submit" id="cadastrar" value="Extrair Relatorio Mensal" />
