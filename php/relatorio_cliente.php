...
<div id=content>
	   ...
	   <form class="userform" name="formulario1" method="post" action="../Relatorio/relatorio_cliente.php">
	   <fieldset id="">
  ...
  <ul>
    <li class="center"><input name="imprimir" type="submit" id="imprimir" value="Imprimir Relatorio" />
      <input type="button" onClick="location.href='index_cliente.php'" value="Cancelar" />
		</li></br>
