...
$sql = "SELECT * FROM responsavel where cpf_resp like '%".$_SESSION['cpf']."%' ";
...
while ($dados = $query->fetch_array())
	...
	// mostra na tela os resultados da busca
		...
		echo '<td align="center">
					<a href="alterar_usuario_cliente.php?id_resp='. ($dados['id_resp']).'" title="Exibir"><img src="../img/lupa.png" alt="Exibir" /></a></tr></td>';
