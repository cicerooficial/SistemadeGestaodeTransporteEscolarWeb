...
where year(parcela.dt_vencimento) = '$ano' and month(parcela.dt_vencimento) = '$mes' and parcela.`pago`= 'Pendente' ";
...
$data = implode("-", array_reverse(explode("-",$data)));
		...
		$pdf->Cell(3.5,1,$resultado['tel_principal'] ,1,0,'C');
